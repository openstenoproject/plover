...
KEYCODES = collections.defaultdict(list, {
    ...
    'Return':[36], 'Tab':[48], 'BackSpace':[51], 'Delete':[117], 'Escape':[53], 
    'Break':[], 'Insert':[], 'Pause':[], 'Print':[], 'Sys_Req':[],
    ...
    'asterisk':[56, 28], 'at':[56, 19], 'backslash':[42], 'braceleft':[56, 33], 
    'braceright':[56, 30], 'bracketleft':[33], 'bracketright':[30], 
    'colon':[56, 41], 'comma':[43], 'division':[], 'dollar':[56, 21], 
    'equal':[24], 'exclam':[56, 18], 'greater':[56, 47], 'hyphen':[], 
    'less':[56, 43], 'minus':[27], 'multiply':[], 'numbersign':[56, 20], 
    'parenleft':[56, 25], 'parenright':[56, 29], 'percent':[56, 23], 
    'period':[47], 'plus':[56, 24], 'question':[56, 44], 'quotedbl':[56, 39], 
    'quoteleft':[], 'quoteright':[], 'semicolon':[41], 'slash':[44], 
    'space':[49], 'underscore':[56, 27],
