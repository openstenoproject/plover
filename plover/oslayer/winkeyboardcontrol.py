...
class KeyboardEmulation:
    ...
    keymap_single = {
        # This library doesn't do anything with just keypresses for alt, ctrl and shift.
        "Alt_L":"",
        "Alt_R":"",
        "Control_L":"",
        "Control_R":"",
    ...
    def __init__(self):
        # Todo(Hesky): Is this hacky? Should we use keybd_event (deprecated) or its replacement SendInput?
