...
version is here: https://github.com/plover/plover/releases/download/v2.5.1/plover.exe
There is no installer, just run the binary 

Mac:
Plover is available for Mac OSX as an app. Download the dmg from:
https://github.com/plover/plover/releases/download/v2.5.1/Plover.dmg
...
run the following commands::
    ...
    wget https://github.com/plover/plover/archive/v2.5.1.tar.gz
